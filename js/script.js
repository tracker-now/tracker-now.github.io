...
function displayRow(i) {
  ...
  $('#detail').append(`<tr id="${trimRonin}">
    ...
    <td class="battle-cont" style="display: none;"><a href="https://tracking.skymavis.com/battle-history?type=pvp&player_id=0x${trimRonin}" target="_blank" class="text-primary"><span class="bi bi-joystick"></span></a></td>
